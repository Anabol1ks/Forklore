...
func NewAuthInterceptor(tokenVerifier authjwt.TokenVerifier, logger *zap.Logger) *AuthInterceptor {
	...
	return &AuthInterceptor{
		...
		logger:        logger,
		protectedMethods: map[string]struct{}{
			"/forklore.profile.v1.ProfileService/GetMyProfile":            {},
			"/forklore.profile.v1.ProfileService/UpdateProfile":           {},
			"/forklore.profile.v1.ProfileService/UpdateProfileReadme":     {},
			"/forklore.profile.v1.ProfileService/UpsertProfileSocialLink": {},
			"/forklore.profile.v1.ProfileService/DeleteProfileSocialLink": {},
			"/forklore.profile.v1.ProfileService/FollowUser":              {},
			"/forklore.profile.v1.ProfileService/UnfollowUser":            {},
			"/forklore.profile.v1.ProfileService/SetProfileTitle":         {},
		},
	}
}
