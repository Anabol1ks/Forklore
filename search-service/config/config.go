	...
	return &Config{
		...
		DB: DB{
			Config: database.Config{
				...
				Port:     getEnv("DB_SEARCH_PORT", log),
				User:     getEnv("DB_SEARCH_USER", log),
				Password: getEnv("DB_SEARCH_PASSWORD", log),
				Name:     getEnv("DB_SEARCH_NAME", log),
				SSLMode:  getEnv("DB_SEARCH_SSLMODE", log),
			},
		},
		Auth: Auth{
